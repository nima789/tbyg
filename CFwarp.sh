...
[[ $cpu = AMD64 ]] && wget -N https://cdn.jsdelivr.net/gh/ygkkkyb/CFwarp/wgcf_2.2.15_amd64 -O /usr/local/bin/wgcf && chmod +x /usr/local/bin/wgcf         
[[ $cpu = ARM64 ]] && wget -N https://cdn.jsdelivr.net/gh/ygkkkyb/CFwarp/wgcf_2.2.15_arm64 -O /usr/local/bin/wgcf && chmod +x /usr/local/bin/wgcf
